    ...
    <section className="relative w-full h-[600px] ">
      ...
      <div className="absolute inset-0 flex flex-col justify-center items-center text-center px-4">
        ...
        <p className="text-gray-300 mt-4 max-w-xl">
          Supplying OEM and aftermarket parts for Cummins, Detroit, Volvo,
          Caterpillar, Mack and more.
        </p>
        ...
        <div className=" mt-6 flex gap-4">
          ...
          <Link
            to="/contact"
            className="border border-white text-white px-6 py-3 rounded hover:bg-white hover:text-black"
          >
            CONTACT US
          </Link>
        </div>
      ...
      <div className="absolute bottom-0 w-full bg-black">
        <div className="max-w-7xl mx-auto text-white py-6 grid grid-cols-2 md:grid-cols-4 ">
          <div className="text-center text-sm flex items-center justify-center flex-col gap-2">
            <div>
              <img className=" w-auto h-10" src={car_parts} alt="" />
            </div>
            OEM & Aftermarket Parts
          </div>
          <div className="text-center text-sm flex items-center justify-center flex-col gap-2">
            <div>
              <img className=" w-auto h-10" src={delivery} alt="" />
            </div>
            Fast Shipping
          </div>
          <div className="text-center text-sm flex items-center justify-center flex-col gap-2">
            <div>
              <img className=" w-auto h-10" src={inventory} alt="" />
            </div>
            Retail & Wholesale Supply
          </div>
          <div className="text-center text-sm flex items-center justify-center flex-col gap-2">
            <div>
              <img className=" w-auto h-10" src={consulting} alt="" />
            </div>
            Expert Assistance
          </div>
        </div>
